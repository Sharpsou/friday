...
`Classer par rayon` lance un job persistant sur le hub. L'indicateur global permet de naviguer ailleurs et de demander l'arrêt. Quand le job termine, l'utilisateur corrige éventuellement l'aperçu puis l'applique. Tant qu'il n'a pas confirmé, aucune classification ne modifie la liste.
...
4. À la fin, ouvrir l'aperçu, corriger les erreurs et appliquer.
5. Contrôler le regroupement direct par rayon et la section `À classer` s'il reste des produits sans classification.
