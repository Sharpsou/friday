...
|     7 | régler les limites `Aujourd'hui` et `Chaque liste Agenda`, puis enregistrer    | chaque liste affiche au plus le nombre choisi ; ses compteurs conservent le total réel                     |               |
