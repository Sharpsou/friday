# Friday — modèle de menace Lot 1A

Date : 9 août 2026
Révision : candidat d'authentification fermée implémenté, recette physique en attente
...
Hors périmètre : Google Calendar, Drive, RSS, Ollama, budget réel, accès Internet au hub et projets sources externes. Ils seront ajoutés au modèle lors de leur lot.
...
- PWA → IndexedDB : tâches, opérations et identité d'appareil ; AES-GCM avec AAD et transactions Dexie atomiques.
...
- Opérateur → Hub : variables, secret d'authentification local, certificats et scripts ; secrets hors dépôt/Drive et ACL Windows attendues.
