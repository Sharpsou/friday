...
> Archive conservée lors de la refonte du 6 septembre 2026, depuis `docs/14-prochaines-etapes-apres-assistant.md` au commit `894a50d`. Les états, chiffres et commandes ci-dessous décrivent leurs dates ; ils ne pilotent pas une reprise. Consulter la [référence active](../../27-etat-canonique-app-robot-2026-08-25.md).
...
1. Rejouer sur le Galaxy A17 les recettes d’authentification, courses, import photo manuscrite, classement, `En course`, budget, Chat local et Veille orchestrée/offline, sans bloquer les autres travaux automatisés.
