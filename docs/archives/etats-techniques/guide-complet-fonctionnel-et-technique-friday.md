...
> Archive conservée lors de la refonte du 6 septembre 2026, depuis `docs/guides/guide-complet-fonctionnel-et-technique-friday.md` au commit `894a50d`. Les états, chiffres et commandes ci-dessous décrivent leurs dates ; ils ne pilotent pas une reprise. Consulter la [référence active](../../guides/guide-complet-fonctionnel-et-technique-friday.md).
...
| `apps/hub/src/assistant/assistant-engine.ts` (ancien chemin, module déplacé ou retiré)                                          | appels Gemma, prompts système, plan JSON et vérification                  |
| `apps/hub/src/assistant/tavily-search.ts` (ancien chemin, module déplacé ou retiré)                                             | client Tavily, retry, limites et compteur distant                         |
| `apps/hub/src/assistant/exa-mcp-search.ts` (ancien chemin, module déplacé ou retiré)                                            | client Exa MCP anonyme, diagnostic et temporisation                       |
...
- [`docs/12-etat-budget-partage.md`](../checkpoints-app/12-etat-budget-partage.md) : checkpoint Budget ;
- [`docs/13-etat-assistant-local.md`](../checkpoints-app/13-etat-assistant-local.md) et [`docs/15-checkpoint-chat-tavily.md`](../checkpoints-app/15-checkpoint-chat-tavily.md) : checkpoint Chat ;
...
- [`docs/17-etat-veille-orchestree.md`](../checkpoints-app/17-etat-veille-orchestree.md) et [`docs/runbooks/veille-rss.md`](../../runbooks/veille-rss.md) : état et exploitation de la Veille ;
