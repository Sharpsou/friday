...
> Archive conservée lors de la refonte du 6 septembre 2026, depuis `docs/10-feuille-de-route-technique-implementation.md` au commit `894a50d`. Les états, chiffres et commandes ci-dessous décrivent leurs dates ; ils ne pilotent pas une reprise. Consulter la [référence active](../../10-feuille-de-route-technique-implementation.md).
