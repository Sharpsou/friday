...
> Archive conservée lors de la refonte du 6 septembre 2026, depuis `docs/15-audit-documentation-2026-08-10.md` au commit `894a50d`. Les états, chiffres et commandes ci-dessous décrivent leurs dates ; ils ne pilotent pas une reprise. Consulter la [référence active](../../27-etat-canonique-app-robot-2026-08-25.md).
...
Le README, les instructions de reprise et les documents canoniques pointent vers [le plan actif](../checkpoints-app/14-prochaines-etapes-apres-assistant.md), le [checkpoint Assistant](../checkpoints-app/13-etat-assistant-local.md) et l’[ADR Tailscale](../../adr/013-acces-exterieur-tailscale-route-privee.md). Les affirmations physiques restent limitées aux retours utilisateur déjà consignés.
